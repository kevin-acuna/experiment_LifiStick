...
int instrument::rotateMotor(int serialNo, double deg)
{
    ...
    const double OFFSET_MOTOR_X_OWP = 1.0; //1.0; // Offset calibration for motor X - External
    const double OFFSET_MOTOR_Y_OWP = -2.0; //-1.0; // Offset calibration for motor Y - Internal
